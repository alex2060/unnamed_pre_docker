...
#CREATE TABLE `a_final_name` ( `keyname` TEXT NOT NULL , `message` TEXT NOT NULL , UNIQUE (`keyname`(248))) ENGINE = MyISAM; 
  ...
  if ($name!="" and $email!="") {
    ...
    $result = $conn->query($sql);
      ...
      $sendurl = "http://alexhaussmann.com/adhaussmann/a_final/output2.php?key=".$hashsolution."&name=".$nameofkey."&entery_name=".$name."&uname=".$mynamer[0];
...
<body style="background-color: #24222a;">
  ...
  <div class="container ">
    ...
    <div class=" d-flex justify-content-center">
      ...
      <form action=<?php echo "\"add_key.php?uname=".$_GET["uname"]."&password=".$_GET["password"]."\"";?> method="post" class="mt-3">
